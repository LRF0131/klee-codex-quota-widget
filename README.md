...
组件始终只显示一条右侧状态，避免任务栏变得拥挤。

| 优先级 | 条件 | 显示示例 |
| ---: | --- | --- |
| 1 | 确认额度明显恢复 | `额度已恢复`，绿色显示五分钟 |
| 2 | `7d = 0%` 且有可用重置机会 | `可重置 ×2` |
| 2 | `7d = 0%` 且没有可用机会或次数未知 | 有可靠时间时显示 `7d 09-08 14:35恢复` |
| 3 | Tibo 明确宣布具体的未来重置时间 | `Tibo 01:26:18` |
| 4 | `5h < 10%` 且 `7d > 0%` | `5h 14:35恢复` 或 `5h 明天00:35恢复` |
| 5 | 其他情况 | 不显示右侧文字 |
